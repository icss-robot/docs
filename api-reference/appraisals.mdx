...
<Note>
  If an identical Appraisal record exists in the same `client_reference` (the same `cpid` and `rpid`), we
  will create a new appraisal record with a different identifier (`appraisal_id`).
</Note>

<EndpointButton
  title="Create Appraisal Endpoint"
  href="/api-reference/default/client_reference-appraisal-1"
/>
...
<Note>Depending how the appraisal was created, the response may contain additional values.</Note>

<EndpointButton
  title="All Appraisals In Specific Client Reference Endpoint"
...
<EndpointButton
  title="Delete All Appraisals In Specific Client Reference Endpoint"
  href="/api-reference/default/client_reference-appraisal-2"
/>
...
<EndpointButton
  title="Modify Specific Appraisal"
  href="/api-reference/default/client_reference-appraisal-4"
/>
...
<EndpointButton
  title="Delete Specific Appraisal"
  href="/api-reference/default/client_reference-appraisal-5"
/>
